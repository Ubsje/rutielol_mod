...
public static class ModelEendman_guard_final extends EntityModel<Entity> {
	...
	public ModelEendman_guard_final() {
		...
		kop.setTextureOffset(0, 16).addBox(-3.5F, -7.0F, -3.3F, 7.0F, 1.0F, 6.0F, 0.0F, false);
		kop.setTextureOffset(16, 4).addBox(-2.5F, -6.0F, -3.3F, 5.0F, 1.0F, 1.0F, 0.0F, false);
		kop.setTextureOffset(0, 4).addBox(-0.5F, -8.0F, -1.3F, 1.0F, 1.0F, 1.0F, 0.0F, false);
		kop.setTextureOffset(16, 0).addBox(-2.5F, -5.0F, 1.7F, 5.0F, 3.0F, 1.0F, 0.0F, false);
		kop.setTextureOffset(10, 23).addBox(-2.5F, -6.0F, 1.7F, 5.0F, 3.0F, 1.0F, 0.0F, false);
