 ...
 *
 *    Keep the RutielolModModElements object in this class and all calls to this object
...
@Mod("rutielol_mod")
public class RutielolModMod {
	public static final Logger LOGGER = LogManager.getLogger(RutielolModMod.class);
	...
	public RutielolModMod() {
		...
		MinecraftForge.EVENT_BUS.register(new RutielolModModFMLBusEvents(this));
	}
