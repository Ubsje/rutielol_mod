...
public class Bewaak1Structure extends RutielolModModElements.ModElement {
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
					...
					if ((random.nextInt(1000000) + 1) <= 2000) {
						...
						for (int a = 0; a < count; a++) {
							...
							Template template = world.getWorld().getStructureTemplateManager()
									.getTemplateDefaulted(new ResourceLocation("rutielol_mod", "bewaak1"));
							if (template == null)
								return false;
			...
			event.getRegistry().register(feature.setRegistryName("bewaak_1"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("rutielol_mod:bewaak_1"), configuredFeature);
		}
	}
	@SubscribeEvent
