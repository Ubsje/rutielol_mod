...
package net.mcreator.rutielolmod.world.biome;
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(12638463).setWaterColor(4159204).setWaterFogColor(329011)
						.withSkyColor(7972607).withFoliageColor(-3355648).withGrassColor(-6697984).build();
				...
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.TREE
						.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(ManexLogItem.block.getDefaultState()),
								new SimpleBlockStateProvider(ManexLeavesItem.block.getDefaultState()),
				...
				mobSpawnInfo.withSpawner(EntityClassification.MONSTER, new MobSpawnInfo.Spawners(EendmanEntity.entity, 20, 4, 4));
				...
				event.getRegistry().register(biome.setRegistryName("rutielol_mod:manexvallei"));
			}
		}
