 ...
 *
 */
package net.mcreator.rutielolmod;
...
public class RutielolModModElements {
	...
	public RutielolModModElements() {
		...
		sounds.put(new ResourceLocation("rutielol_mod", "trommel"),
				new net.minecraft.util.SoundEvent(new ResourceLocation("rutielol_mod", "trommel")));
		sounds.put(new ResourceLocation("rutielol_mod", "tuu"), new net.minecraft.util.SoundEvent(new ResourceLocation("rutielol_mod", "tuu")));
		try {
			...
			for (ModFileScanData.AnnotationData annotationData : annotations) {
				if (annotationData.getAnnotationType().getClassName().equals(ModElement.Tag.class.getName())) {
					...
					if (clazz.getSuperclass() == RutielolModModElements.ModElement.class)
						elements.add((RutielolModModElements.ModElement) clazz.getConstructor(this.getClass()).newInstance(this));
				}
			}
		} catch (Exception e) {
			e.printStackTrace();
		...
		elements.forEach(RutielolModModElements.ModElement::initElements);
	}
