...
import net.mcreator.rutielolmod.procedures.ManexNoteblockOnBlockRightClickedProcedure;
...
public class ManexNoteblockBlock extends RutielolModModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("manex_noteblock");
		}
			...
			if (world.getRedstonePowerFromNeighbors(new BlockPos(x, y, z)) > 0) {
				{
					...
					ManexNoteblockOnBlockRightClickedProcedure.executeProcedure($_dependencies);
				}
			} else {
			}
		}
