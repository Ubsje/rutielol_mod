...
public class ManexLogBlock extends RutielolModModElements.ModElement {
	@ObjectHolder("rutielol_mod:manex_log")
	public static final Block block = null;
	public ManexLogBlock(RutielolModModElements instance) {
		super(instance, 6);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(1.1f, 10f).setLightLevel(s -> 0).harvestLevel(0)
					.harvestTool(ToolType.AXE).setRequiresTool());
			this.setDefaultState(this.stateContainer.getBaseState().with(FACING, Direction.SOUTH));
			setRegistryName("manex_log");
		}
