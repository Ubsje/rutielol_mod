...
import net.mcreator.rutielolmod.entity.renderer.AapRenderer;
import net.mcreator.rutielolmod.RutielolModModElements;

@RutielolModModElements.ModElement.Tag
public class AapEntity extends RutielolModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -10079488, -16777216, new Item.Properties().group(RutieLolModItemGroup.tab))
				.setRegistryName("aap_spawn_egg"));
	}

	@SubscribeEvent
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		event.getSpawns().getSpawner(EntityClassification.CREATURE).add(new MobSpawnInfo.Spawners(entity, 20, 6, 10));
	}
